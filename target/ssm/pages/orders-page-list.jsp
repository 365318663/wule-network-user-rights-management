                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline"  onchange="changePageSize()">
                            总共 ${pageInfo.pages} 页，共${pageInfo.total} 条订单。 每页
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
								<c:choose>
									<c:when test="${pageInfo.pageNum==pageNum}">    <!--如果 -->
										<li class="paginate_button active"><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageNum}&&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
									</c:when>
									<c:otherwise>  <!--否则 -->
